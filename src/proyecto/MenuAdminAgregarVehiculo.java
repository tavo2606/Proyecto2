...
public class MenuAdminAgregarVehiculo extends javax.swing.JInternalFrame {

    private Connection connection = null;
    private ResultSet rs = null;
    private Statement s = null;
    
    public MenuAdminAgregarVehiculo() {
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try{
            ...
            int p = Integer.parseInt(txtPlaca.getText());
            ...
            s = connection.createStatement();
            int z = s.executeUpdate("INSERT INTO vehiculo (\"placa\", \"año\", \"precio\", "
                                                         + "\"estado\", \"estilo\", \"modelo\", "
                                                         + "\"marca\", \"transmision\") VALUES("
                                                         + "'"+p+"', '"+a+"', '"+pre+"', "
                                                         + "'"+est+"', '"+e+"', '"+m+"', "
                                                         + "'"+marc+"', '"+trans+"')");
            
            if(z==1){
                JOptionPane.showMessageDialog(null, "Vehículo agregado", "Agregado", JOptionPane.DEFAULT_OPTION);
            }else{
                JOptionPane.showMessageDialog(null, "Vehículo no agregado", "Error", JOptionPane.DEFAULT_OPTION);
            }
